...
function savePost(el) {
	...
	let ajax = $.ajax({
		...
		beforeSend: function() {
			...
			if (iconEl) {
				iconEl.removeClass('fa-solid fa-bookmark');
	...
	ajax.done(function (xhr) {
		...
		if (typeof xhr.isLogged === 'undefined') {
			...
			if (iconEl) {
				...
				iconEl.addClass('fa-solid fa-bookmark').removeAttr('role aria-hidden');
			}
		...
		if (xhr.isSaved === true) {
			if ($(el).hasClass('btn')) {
				...
				$(el).html('<i class="fa-solid fa-bookmark" data-bs-toggle="tooltip" title="' + lang.labelSavePostRemove + '"></i>');
			}
			...
			if ($(el).hasClass('btn')) {
				...
				$(el).html('<i class="fa-regular fa-bookmark" data-bs-toggle="tooltip" title="' + lang.labelSavePostSave + '"></i>');
			}
